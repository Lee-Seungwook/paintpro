...
#ifndef _DLL_GEOMETRY_
#define _DLL_GEOMETRY_
#endif // !_DLL_GEOMETRY_

#include "GeometryAPI.h"

// 이동 변환 함수 구현
void GeometryAPI::APITranslate(IppByteImage& imgSrc, IppByteImage& imgDst, int sx, int sy)
{
...
// 이동 변환 함수 트루컬러 구현
void GeometryAPI::APICTranslate(IppRgbImage& imgSrc, IppRgbImage& imgDst, int sx, int sy)
{
	int w = imgSrc.GetWidth();
	int h = imgSrc.GetHeight();
...
// 최근방 이웃 보간법 구현
void GeometryAPI::APIResizeNearest(IppByteImage& imgSrc, IppByteImage& imgDst, int nw, int nh)
{
	int w = imgSrc.GetWidth();
	int h = imgSrc.GetHeight();
...
void GeometryAPI::APIResizeBilinear(IppByteImage& imgSrc, IppByteImage& imgDst, int nw, int nh)
{
	int w = imgSrc.GetWidth();
	int h = imgSrc.GetHeight();
...
void GeometryAPI::APIResizeCubic(IppByteImage& imgSrc, IppByteImage& imgDst, int nw, int nh)
{
	int w = imgSrc.GetWidth();
	int h = imgSrc.GetHeight();
...
double GeometryAPI::cubic_interpolation(double v1, double v2, double v3, double v4, double d)
{
...
// 영상의 회전 변환 구현
void GeometryAPI::APIRotate(IppByteImage& imgSrc, IppByteImage& imgDst, double angle)
{
	int w = imgSrc.GetWidth();
	int h = imgSrc.GetHeight();
...
// 영상의 90도 회전 변환
void GeometryAPI::APIRotate90(IppByteImage& imgSrc, IppByteImage& imgDst)
{
	int w = imgSrc.GetWidth();
	int h = imgSrc.GetHeight();
...
// 영상의 180도 회전 변환
void GeometryAPI::APIRotate180(IppByteImage& imgSrc, IppByteImage& imgDst)
{
	int w = imgSrc.GetWidth();
	int h = imgSrc.GetHeight();
...
// 영상의 270도 회전 변환
void GeometryAPI::APIRotate270(IppByteImage& imgSrc, IppByteImage& imgDst)
{
...
// 영상의 좌우 반전 구현
void GeometryAPI::APIMirror(IppByteImage& imgSrc, IppByteImage& imgDst)
{
	int w = imgSrc.GetWidth();
	int h = imgSrc.GetHeight();
...
// 영상의 상하 반전 구현
void GeometryAPI::APIFlip(IppByteImage& imgSrc, IppByteImage& imgDst)
{
	int w = imgSrc.GetWidth();
	int h = imgSrc.GetHeight();
